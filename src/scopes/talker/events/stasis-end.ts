...
export class StasisEnd extends EventBase {
  public async call() {
    ...
    // this.logger.info(`End call for channel ${this.channelId}(${channel.ip}) ✅. Duration - ${duration} s.`)
    this.logger.info(`End call for channel ${this.channelId} ✅. Duration - ${duration}s.`)
  }
}
